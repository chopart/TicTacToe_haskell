...
prop_alphabetaSolutionShouldEqualMinimaxSolution =   forAll (arbitrary :: Gen Bool) $ \startingPlayer -> 
                                        forAll anyNimGame $ \game -> 
                                        minimax game (startTree game startingPlayer) == minimaxAlphaBeta game (minBound,maxBound) (startTree game startingPlayer)
...
prop_boundedAlphabetaIsOptimalForNim =  forAll (choose (1,5) :: Gen Int) $ \d -> 
                                        ...
                                        minimaxAlphaBetaBounded (Nim d xs) d (minBound,maxBound) (startTree game startingPlayer) == minimaxAlphaBeta game (minBound,maxBound) (startTree game startingPlayer) 


prop_pruningShouldBeDoneCorrectlyForStaticTestTrees = [minimaxAlphaBeta game (minBound,maxBound) (startTree game True)  | game <- enumFrom (toEnum 0 :: StaticGame)] == [(Just 2,5),(Just 1,6),(Just 0,3),(Just 0,3),(Just 2,13),(Just 0,4),(Just 0,15),(Just 1,7),(Just 0,5),(Just 1,6)]
